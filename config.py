...
class Config(object):
    ...
    """
    def __init__(self): 
        self.data_dir = Path(r'E:\Brisbane_Pine GIS QGIS_2018')
        self.brispath = Path(r'E:\Brisbane_Pine GIS QGIS_2018\Brisbane GIS data\Brisbane basemap\dbh_shapefiles')
        self.bris_dirs = {'folder':r'E:\Brisbane_Pine GIS QGIS_2018\Brisbane GIS data\Brisbane basemap\dbh_shapefiles',
        ...
        self.kobble_dirs = {'folder':r'E:\Brisbane_Pine GIS QGIS_2018\Brisbane GIS data\Kobble_Creek_2015\kobble shapefiles',
        ...
        self.pine_dirs = {'folder':r'E:\Brisbane_Pine GIS QGIS_2018\Brisbane GIS data\Lidar_Pine\Pine shapefiles',
        ...
        self.mary_dirs = {'folder':r'E:\Brisbane_Pine GIS QGIS_2018\Mary River imagery\shapefiles',
